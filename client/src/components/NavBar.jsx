...
const NavBar = () => {
    ...
    useEffect(() => {
  // अगर home page नहीं है तो हमेशा scrolled मानो
  ...
  return () => window.removeEventListener("scroll", handleScroll);
    ...
    return (
            ...
            <nav
                 ...
                 z-50 backdrop-blur-lg transition-all duration-700 ease-in-out
                ${isScrolled ? "bg-white/90 shadow-md text-gray-800 backdrop-blur-lg py-3 md:py-4"
                ...
                {/* Logo */}
                <Link to = "/">
                    <img  className={`h-9 ${isScrolled && "invert opacity-80"}`}
                    src={assets.logo}>
