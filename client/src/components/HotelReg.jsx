    ...
    <div className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70'>
        ...
        >
            ...
            <div className="mt-4 w-full">
                <label htmlFor="name" 
                className='font-medium text-gray-500'>Hotel Name</label>
                <input 
            ...
            <div className="mt-4 w-full">
                ...
                className='font-medium text-gray-500'>Phon</label>
                <input 
                className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light'
                placeholder='Type here'
                id='contact'
            ...
            <div className="mt-4 w-full">
                ...
                className='font-medium text-gray-500'>Address</label>
                <input 
                className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light'
                placeholder='Type here'
                id='address'
            ...
            {/* {city drop down} */}
            <div className="mt-4 w-full max-w-60 mr-auto">
                <label htmlFor="city" 
